import { MEDICAL_COMPLIANCE_SYSTEM_PROMPT, CLINICAL_OBSERVATION_LIMITS } from '@/content/lib/medical-compliance';
...
- E-E-A-T(경험·전문성·권위·신뢰): 실제 진료 현장에서 일반적으로 관찰되는 양상과 판단 기준을 구체적으로 서술
  1인칭 임상 관찰("진료실에서 보면", "환자분들 보면")과 증상·생활 상황 묘사는 적극 사용하되,
  개인을 특정하거나 한 환자의 진료 과정을 재구성한 사례·서사·후기 형식은 쓰지 않는다
...
- "~하겠습니다 / 짚어드리겠습니다 / 알아보겠습니다 / 정리해드리겠습니다" 류의 예고·강의 톤 문장 금지(특히 도입부). 글은 곧바로 주제 내용으로 시작
...
- 진료 현장에서 일반적으로 관찰되는 양상·전형적 상황을 단락마다 녹일 것 ("진료실에서 보면 ~한 분들이 많습니다")
...
- [이미지 N: 설명] 형식으로 총 5~6개 배치하되, 각 소제목의 첫 단락(직답) 뒤에 둘 것. 소제목 바로 다음 줄에 이미지를 두지 말 것 — 소제목 직후에는 반드시 본문 직답이 먼저 와야 한다
