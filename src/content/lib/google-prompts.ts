...
- 본문이 자연스럽게 흐르도록 작성`;
  ...
  const lengthHint = isGeoMode
    ? '1,800~2,100자 (공백 포함, 요약 박스·FAQ 제외) — 2,200자 절대 초과 금지. 깊이·주제 완결성은 유지하되, 분량이 넘치면 부연·중복 설명을 덜어 압축할 것'
    : '1,800~2,100자 (공백 포함, 본문만) — 2,200자 절대 초과 금지. 깊이·주제 완결성은 유지하되, 분량이 넘치면 부연·중복 설명을 덜어 압축할 것';
