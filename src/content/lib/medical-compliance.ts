...
const WARNING_PATTERNS: PatternRule[] = [
  ...
  // 2026-W30: 전문병원·전문의원 무단 표방 — 복지부 지정 없이 '전문병원' 명칭 사용은 금지(의료법 제3조의5 제4항).
  // 오탐 배제: "전문의와 상담"(권장 문구)·"전문의 진단"은 매칭하지 않는다 — 병원/의원/클리닉 명사 결합일 때만.
  {
    pattern: /전문\s*(?:병원|의원|클리닉|센터)(?!.{0,4}지정)/,
    message: '‘전문병원·전문클리닉’ 명칭은 보건복지부 지정 기관만 사용할 수 있습니다(의료법 제3조의5).',
    severity: 'HIGH',
