 ...
 * 중복·2자 미만은 제거한다.
 */
export export function buildRegistrySeedsForProbe(name: string): readonly string[] { return buildRegistrySeeds(name); }

function buildRegistrySeeds(name: string): readonly string[] {
