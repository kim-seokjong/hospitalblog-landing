    ...
    <main className="min-h-screen bg-gray-950 text-gray-300">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl font-bold text-white mb-3">개인정보처리방침</h1>
          <p className="text-sm text-gray-500">시행일: 2026년 5월 2일 &nbsp;|&nbsp; 최종 수정: 2026년 5월 2일</p>
        </div>
        ...
        <div className="space-y-10 text-sm leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                <p className="font-medium text-gray-200 mb-2">회원가입 및 서비스 이용</p>
              ...
              <div>
                <p className="font-medium text-gray-200 mb-2">결제 시</p>
                <ul className="list-disc list-inside space-y-1 text-gray-400 ml-2">
              ...
              <div>
                <p className="font-medium text-gray-200 mb-2">서비스 이용 과정에서 자동 수집</p>
                <ul className="list-disc list-inside space-y-1 text-gray-400 ml-2">
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="bg-gray-900">
                    <th className="text-left px-4 py-3 text-gray-300 font-medium border border-gray-800">항목</th>
                    <th className="text-left px-4 py-3 text-gray-300 font-medium border border-gray-800">보유 기간</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={item} className="border-b border-gray-800">
                      <td className="px-4 py-3 text-gray-400 border border-gray-800">{item}</td>
                      <td className="px-4 py-3 text-gray-400 border border-gray-800">{period}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <section>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="bg-gray-900">
                    <th className="text-left px-4 py-3 text-gray-300 font-medium border border-gray-800">수탁업체</th>
                    <th className="text-left px-4 py-3 text-gray-300 font-medium border border-gray-800">위탁 업무</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={company} className="border-b border-gray-800">
                      <td className="px-4 py-3 text-gray-400 border border-gray-800">{company}</td>
                      <td className="px-4 py-3 text-gray-400 border border-gray-800">{task}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <section>
            ...
            <p className="text-gray-400 mt-3">
              권리 행사는 <a href="mailto:terro6936@gmail.com" className="text-blue-400 hover:text-blue-300 underline">terro6936@gmail.com</a> 으로 이메일 문의하시면 처리해 드립니다.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-gray-900 rounded-xl p-5 space-y-2 text-gray-400">
              ...
              <p><span className="text-gray-300">이메일:</span>{' '}
