    ...
    <main className="min-h-screen bg-gray-950 text-gray-300">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl font-bold text-white mb-3">환불·해지정책</h1>
        ...
        <div className="space-y-10 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-400 ml-2">
              <li>본 서비스는 <strong className="text-gray-200">월 자동갱신 구독</strong> 방식으로만 운영됩니다.</li>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-400 ml-2">
              <li>로그인 후 <strong className="text-gray-200">마이페이지</strong> (<code className="text-blue-400">/app/subscription</code>) 진입</li>
              <li><strong className="text-gray-200">"구독 해지"</strong> 버튼 클릭 → 확인</li>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-3 text-gray-400 ml-2">
              ...
              <li>
                <strong className="text-gray-200">환불 수단:</strong> 결제한 카드로 원상복구 (카드사 정책에 따라 3~5 영업일 소요)
              </li>
            </ol>
          </section>
