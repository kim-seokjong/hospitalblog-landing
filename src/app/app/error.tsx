...
export default function AppError({
  ...
  return (
    <div className="min-h-screen bg-[#eaeef4] text-[#202020] flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            href="/app"
            className="px-6 py-3 bg-white hover:bg-[#eef2f6] text-[#202020] font-semibold rounded-xl transition-colors border border-[#b4bfce]"
          >
            새로고침
          </Link>
        </div>
