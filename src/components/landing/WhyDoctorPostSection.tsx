...
const REASONS = [
  {
    icon: '🛡️',
    title: '의료광고법 자동 검사·차단',
    desc: '발행 후가 아니라 글 쓰는 단계에서 위험 표현을 자동 검사하고 차단해, 행정처분으로 이어질 수 있는 위험을 줄여요.',
  ...
  {
    icon: '📊',
    title: '순위 추적 + ROI 시뮬레이터',
    desc: '발행 후 검색 순위를 매일 자동 추적하고, ROI 시뮬레이터로 블로그 운영의 성과 흐름을 확인해요.',
    iconClass: 'bg-[#eef2f6] text-[#3f5468]',
  },
];
